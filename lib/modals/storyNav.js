...
let slides = [
  ...
  slideMaker(
    "Tutorial",
    "1. Click left or right to progress.<br />2. Scroll up or down within this panel to see additional instructions.<br />3. Hover or Click on states for more information.<br />4. Click on About to learn more about the data and this project.<br />5. Click on View to more directly interact with the data"
  ),

...
let slides = [
  ...
  slideMaker(
    "Tutorial",
    "$1. Click left or right to progress. $2. Scroll up or down within this panel to see additional instructions. $3. Hover or Click on states for more information. $4. Click on About to learn more about the data and this project. $5. Click on View to more directly interact with the data"
  ),
